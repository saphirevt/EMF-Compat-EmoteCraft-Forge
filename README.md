...
This mod allows you to apply bending from bendy-lib to the cuboids of the player model from EMF (and from resource packs, for example, Fresh Animations: Player Extension).
